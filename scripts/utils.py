...
from os import environ, listdir, path, remove, walk
import sys
import shutil
import subprocess
...
from scripts.fonttools_types import GaspTable, HheaTable, OS2Table
...
def adjust_line_height(
    ...
    head.yMax = new_ascender
    head.yMin = new_descender
    hhea.ascent = new_ascender
    hhea.descent = new_descender
    os2 = cast(OS2Table, os2)
