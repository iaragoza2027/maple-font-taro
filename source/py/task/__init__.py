...
from . import cjk, compatibility, fea, merge, nf, page, publish, release


CommandHandler = Callable[[argparse.Namespace], None]


def _register(parser: argparse._SubParsersAction[argparse.ArgumentParser], module) -> None:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    for module in (nf, fea, release, page, cjk, publish, merge, compatibility):
